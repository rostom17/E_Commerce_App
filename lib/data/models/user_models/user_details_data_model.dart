...
import 'package:e_commerce_app/data/models/user_models/user_dummy_data_model.dart';
...
class UserDetailsDataModel {
  ...
  UserDetailsDataModel.fromJson(Map<String, dynamic> json) {
    ...
    user = json['user'] != null ?  UserDummyDataModel.fromJson(json['user']) : null;
  }
